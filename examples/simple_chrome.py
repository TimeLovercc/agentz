...
from pipelines.simple_chrome import SimpleChromePipeline


# Example 1: Using config file
def run_with_config():
    """Run pipeline using YAML configuration."""
    pipeline = SimpleChromePipeline("pipelines/configs/simple_chrome.yaml")
...
def run_with_override():
    ...
    pipeline = SimpleChromePipeline({
        "config_path": "pipelines/configs/simple_chrome.yaml",
        "data": {
